                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Kph</label>
                                <input type="text" name="kph" class="form-control" id="exampleInputPassword1" placeholder="Kph Asset">
                                <?= form_error('kph', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Pemegang Hak</label>
                                        <input type="text" name="pemegang" class="form-control" id="exampleInputPassword1" placeholder="Pemegang Hak">
