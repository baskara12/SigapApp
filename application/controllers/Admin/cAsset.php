...
class cAsset extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('kph', 'Kph Asset', 'required');
        $this->form_validation->set_rules('pemegang', 'pemegang hak Asset', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!$this->upload->do_upload('gambar')) {
                ...
                $data = array(
                    ...
                    'pemegang_hak' => $this->input->post('pemegang'),
